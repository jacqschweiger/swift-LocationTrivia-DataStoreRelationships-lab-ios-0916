...
//singleton. unchangeable instance of a class. this is already populated with the locations. LocationDataStore.sharedInstance is all the locations. Can call on locations to access all the properties for the locations. 
